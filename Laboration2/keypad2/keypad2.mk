...
ProjectPath            :=C:/Users/carls/OneDrive/Chalmers/DAT017/Laboration2/keypad2
...
PostBuild:
	...
	C:\cseapp\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  ./Debug/keypad2.elf ./Debug/keypad2.s19
	C:\cseapp\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S ./Debug/keypad2.elf > ./Debug/keypad2.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c 
	$(CC) $(SourceSwitch) "C:/Users/carls/OneDrive/Chalmers/DAT017/Laboration2/keypad2/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
